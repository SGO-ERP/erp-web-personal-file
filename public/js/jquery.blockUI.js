...
(function () {
    ...
    function setup($) {
        ...
        $.fn.customFileInput = function () {
            ...
            var uploadButton = $(
                '<div class="customfile-button" aria-hidden="true">Выбрать файл</div>',
            ).appendTo(upload);
            //create custom control feedback
            var uploadFeedback = $(
                '<span class="customfile-feedback" aria-hidden="true">Файл не выбран...</span>',
            ).appendTo(upload);
        ...
        $.blockUI.version = 2.5; // 2nd generation blocking at no extra cost!
