...
import { POLYGRAPH_EXAMINER } from '../../../../../../../constants/PositionNames';
...
const ModalAddResultsPolyg = ({ isOpen, onClose }) => {
    const [file, setFile] = useState();
    const dispatch = useDispatch();
    const [form] = Form.useForm();
    const result_polygraph = useSelector(
        (state) => state.myInfo.allTabs.additional.result_polygraph,
    );
    ...
    const onOk = async () => {
        try {
            ...
            dispatch(
                setFieldValue({
                    fieldPath: 'allTabs.additional.polygraph_checks',
                    value: [...result_polygraph, newObject],
                }),
            );
            form.resetFields();
            onClose();
...
export default ModalAddResultsPolyg;
