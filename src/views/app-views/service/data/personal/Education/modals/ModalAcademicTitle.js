...
const ModalAcademicTitle = ({ isOpen, onClose }) => {
    ...
    const { add_academic_title } = useSelector((state) => state.myInfo.allTabs.education);
    ...
    const handleOk = async () => {
        try {
            ...
            const newAcademicTitle = {
                degree_id: optionValue.degree_title,
            ...
            dispatch(
                setFieldValue({
                    fieldPath: "allTabs.education.add_academic_title",
                    value: [...add_academic_title, newAcademicTitle],
                }),
            );
    ...
    return (
        <div onClick={(e) => e.stopPropagation()}>
            <Modal
                // title={'Добавление учёного звания'}
                title={
                    <div
                        style={{
                            display: "flex",
                    ...
                    >
                        <span>
                            <IntlMessage id={"service.data.modalAcademicTitle.AddRank"} />
                        </span>
                    </div>
                }
                open={isOpen && isHR}
            ...
            >
                <Form form={form} layout="vertical">
                    <Form.Item
                        label={<IntlMessage id={"service.data.modalAcademicTitle.AddRank"} />}
                        name="degree_title"
                        rules={[
                            {
                    ...
                    >
                        <SelectPickerMenu
                            ...
                            currentOptions={setTitleDegreeOptions}
                            searchText={searchText}
                            placeholder={"service.data.modalAcademicTitle.AddRank"}
                        />
                    </Form.Item>
