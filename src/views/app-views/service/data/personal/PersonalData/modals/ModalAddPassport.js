...
const ModalAddPassport = ({ isOpen, onClose, passport,source }) => {
        ...
        try {
            ...
            if (response) {
                ...
                if(source==='add') {
                    dispatch(
                        setFieldValue({
                            fieldPath: 'allTabs.personal_data.passport_document_link',
                            value: newObject,
                        }),
                    );
                } else if (source==='edit') {
                    dispatch(
                        setFieldValue({
                            fieldPath: 'edited.personal_data.passport_document_link',
                            value: newObject,
                        }),
                    );
                }
...
export default ModalAddPassport;
