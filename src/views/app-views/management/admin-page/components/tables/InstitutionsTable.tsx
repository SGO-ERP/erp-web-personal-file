...
import { setTablePage, setTableSize } from "store/slices/admin-page/adminInstitutionsSlice";
import IntlMessage from "../../../../../../components/util-components/IntlMessage";
import { useAppDispatch, useAppSelector } from "../../../../../../hooks/useStore";
import { nameSorter, tableInstitutionDelete } from "../utils/TableFunctions";
...
const InstitutionsTable = ({ setRecord, record }: Props) => {
    ...
    const { institution_types, tablePagination } = useAppSelector(
        (state) => state.adminInstitutions,
    );
    ...
    useEffect(() => {
        setLoading(institution_types.loading);
    }, [institution_types.loading]);
    ...
    useEffect(() => {
        const filteredData =
            tableSearch.trim() === ""
                ? institution_types.data.objects
                : institution_types.data.objects.filter(
                      (e: any) =>
    ...
    }, [institution_types.data, tableSearch]);
            ...
            render: (_: string, record: any) => (
                <Row>
                    <Button
                        ...
                        onClick={() => {
                            if (record.id) {
                                tableInstitutionDelete(record.id);
                            }
                        }}
                    >
