...
import { nameSorter, tableMilitaryInstitutionDelete } from "../utils/TableFunctions";
import {
    setTablePage,
    setTableSize,
} from "../../../../../../store/slices/admin-page/adminMilitaryInstitutionSlice";
...
const MilitaryInstitutionTable = ({ setRecord, record }: Props) => {
    ...
    const { military_institution_types, tablePagination } = useAppSelector(
    ...
    useEffect(() => {
        setLoading(military_institution_types.loading);
    }, [military_institution_types.loading]);
    ...
    useEffect(() => {
        const filteredData =
            tableSearch.trim() === ""
                ? military_institution_types.data.objects
                : military_institution_types.data.objects.filter(
                      (e: any) =>
    ...
    }, [military_institution_types.data, tableSearch]);
            ...
            render: (_: string, record: any) => (
                <Row>
                    <Button
                        ...
                        onClick={() => {
                            if (record.id) {
                                tableMilitaryInstitutionDelete(record.id);
                            }
                        }}
                    >
...
export default MilitaryInstitutionTable;
